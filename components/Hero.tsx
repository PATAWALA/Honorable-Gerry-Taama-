...
export default function Hero() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center bg-gradient-to-b from-[#161618] to-[#0F0F10] px-4 border-b border-[#27272A] pt-14 md:pt-0 pb-10 md:pb-0">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 items-center">
        
        {/* BLOC VISUEL (IMAGE & BADGE EN HAUT SUR MOBILE - REMONTÉ AU MAXIMUM) */}
        <div className="order-1 md:order-2 flex flex-col items-center justify-center pt-2 md:pt-0">
          {/* Le badge - Éloigné de l'image grâce à une marge basse dédiée (mb-4) */}
          ...
          <div className="relative group">
            ...
            <img 
              ...
              className="relative rounded-2xl border border-[#3F3F46] object-cover w-[240px] h-[300px] sm:w-[300px] sm:h-[380px] md:w-[400px] md:h-[500px]"
            />
          </div>
        </div>

        {/* BLOC TEXTE & ACCROCHE (CONTENU REMONTÉ EN SERRANT LES MARGES) */}
